...
// enregistrer
        ...
        if(p==0){
            ...
            try {
                ...
                conn=Database.java_db();//connection
                String sql ="insert into Test.document(nom_document,chemp_document)values (?,?)";
                
                stmt=conn.prepareStatement(sql);
                
                stmt.setString(1,nom_doc.getText());
                stmt.setString(2,chemp_doc.getText());
                stmt.execute();
    ...
    private void attacher_docActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_attacher_docActionPerformed
    ...
    }//GEN-LAST:event_attacher_docActionPerformed
